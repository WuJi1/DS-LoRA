...
def get_module_input_output_at_words(
    ...
    """
    Retrieves detached representations for a word at the input and/or
    output of a particular layer module.

    track:
        "in"   : only return module input
        "out"  : only return module output
        "both" : return both input and output
    """
